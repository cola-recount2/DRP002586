...
```{r, echo = FALSE, message = FALSE}
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
...
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 7)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 7, fun = consensus_heatmap)', 'k = 7', opt = 'fig.width = 15, fig.height = 12, results = "hide"')
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 8)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 8, fun = consensus_heatmap)', 'k = 8', opt = 'fig.width = 15, fig.height = 12, results = "hide"')
knitr_insert_tabs()
```
...
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 7)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 7, fun = membership_heatmap)', 'k = 7', opt = 'fig.width =15, fig.height = 12, results = "hide"')
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 8)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 8, fun = membership_heatmap)', 'k = 8', opt = 'fig.width =15, fig.height = 12, results = "hide"')
knitr_insert_tabs()
```
...
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 7)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 7, fun = get_signatures)', 'k = 7', opt = 'fig.width = 15, fig.height = 12, results = "hide"')
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 8)", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 8, fun = get_signatures)', 'k = 8', opt = 'fig.width = 15, fig.height = 12, results = "hide"')
knitr_insert_tabs()
```
...
knitr_add_tab_item('get_stat(res_list, k = 7)', 'k = 7')
knitr_add_tab_item('get_stat(res_list, k = 8)', 'k = 8')
knitr_insert_tabs()
```
...
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - classifications from all methods (k = 7)", appendLF = FALSE)
knitr_add_tab_item('collect_classes(res_list, k = 7)', 'k = 7', opt = 'fig.width = 8, fig.height = 8')
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - classifications from all methods (k = 8)", appendLF = FALSE)
knitr_add_tab_item('collect_classes(res_list, k = 8)', 'k = 8', opt = 'fig.width = 8, fig.height = 8')
knitr_insert_tabs()
```
...
```{r, echo = FALSE, message = FALSE}
t1 = Sys.time()
message("  - collecting all plots (k = '2, 3, 4, 5, 6, 7, 8')", appendLF = FALSE)
```
...
```{r sd-hclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
knitr_add_tab_item('cbind(get_classes(res, k = 7), get_membership(res, k = 7))', 'k = 7')
knitr_add_tab_item('cbind(get_classes(res, k = 8), get_membership(res, k = 8))', 'k = 8')
knitr_insert_tabs()
```
...
```{r, echo = FALSE, message = FALSE}
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - making consensus heatmaps (k = '2, 3, 4, 5, 6, 7, 8')", appendLF = FALSE)
```
...
knitr_add_tab_item('consensus_heatmap(res, k = 7)', 'k = 7')
knitr_add_tab_item('consensus_heatmap(res, k = 8)', 'k = 8')
knitr_insert_tabs()
```
...
```{r, echo = FALSE, message = FALSE}
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - making membership heatmaps (k = '2, 3, 4, 5, 6, 7, 8')", appendLF = FALSE)
```
...
knitr_add_tab_item('membership_heatmap(res, k = 7)', 'k = 7')
knitr_add_tab_item('membership_heatmap(res, k = 8)', 'k = 8')
knitr_insert_tabs()
```
...
```{r, echo = FALSE, message = FALSE}
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - getting signatures (k = '2, 3, 4, 5, 6, 7, 8')", appendLF = FALSE)
```
...
knitr_add_tab_item('get_signatures(res, k = 7)', 'k = 7', opt = 'results = "hide"')
knitr_add_tab_item('get_signatures(res, k = 8)', 'k = 8', opt = 'results = "hide"')
knitr_insert_tabs()
```
...
knitr_add_tab_item('get_signatures(res, k = 7, scale_rows = FALSE)', 'k = 7', opt = 'results = "hide"')
knitr_add_tab_item('get_signatures(res, k = 8, scale_rows = FALSE)', 'k = 8', opt = 'results = "hide"')
knitr_insert_tabs()
```
...
```{r, echo = FALSE, message = FALSE}
t2 = Sys.time(); message(gsub("^ +", ", ", format(t2 - t1))); t1 = Sys.time()
message("  - making PCA plots (k = '2, 3, 4, 5, 6, 7, 8')", appendLF = FALSE)
```
...
knitr_add_tab_item('dimension_reduction(res, k = 7)', 'k = 7')
knitr_add_tab_item('dimension_reduction(res, k = 8)', 'k = 8')
knitr_insert_tabs()
```
...
```{r sd-kmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r sd-skmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r sd-pam-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r sd-mclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r cv-hclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r cv-kmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r cv-skmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r cv-pam-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r cv-mclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r MAD-hclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r MAD-kmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r MAD-skmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r MAD-pam-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r MAD-mclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r AAC-hclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r AAC-kmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r AAC-skmeans-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r AAC-pam-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
...
```{r AAC-mclust-collect-plots, fig.width = 21, fig.height = 12, results = "hide"}
collect_plots(res)
```
